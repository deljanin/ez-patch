...
const mansfield = localFont({
  src: [
    ...
    { path: "../fonts/MansfieldSemiBold.woff", weight: "600", style: "normal" },
    { path: "../fonts/MansfieldSemiBold.otf", weight: "600", style: "normal" },
    {
...
export default async function RootLayout({
  ...
  return (
    <html lang={locale}>
      <body
        className={`${montserrat.variable} ${mansfield.variable} font-mansfield bg-white-main antialiased`}
      >
        <SmoothScroll>
